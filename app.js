...
function calculateResults() {
  ...
  const totalIntrests = document.getElementById('total-intrests');
  ...
  if (isFinite(monthly)){
    ...
    totalIntrests.value = ((monthly * calculatedPayments) - principal).toFixed(2); 
...
function showError(error) {
  ...
  // clear error after certain amount of time
